...
namespace Commands
{
	...
	inline constexpr const wchar_t* InsertFormatSpecifier()
	{
		constexpr const wchar_t* vcxprojTemplate = LR"XML(
		...
		<Project DefaultTargets="Build" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
		  ...
		  <PropertyGroup Condition="'$(Configuration)|$(Platform)'=='Debug|x64'">
			...
			<NMakeOutput>NMAKESample.exe</NMakeOutput>
		  ...
		  <PropertyGroup Condition="'$(Configuration)|$(Platform)'=='Development|x64'">
			<NMakeBuildCommandLine>gch</NMakeBuildCommandLine>
			<NMakeOutput>NMAKESample.dll</NMakeOutput>
			<NMakePreprocessorDefinitions>MR_DEBUG;$(NMakePreprocessorDefinitions)</NMakePreprocessorDefinitions>
		  </PropertyGroup>
	...
	void Generate_Cmd()
	{
		...
		if (sourceDirectory && intermediateDirectory)
		{
			...
			static MemoryBlockArena<char> moduleBuffer = { 16_mB };
			for (Module& mdl : modules)
			{
				...
				{
					const u32 required = (u32)swprintf(nullptr, InsertFormatSpecifier(), );

					//swprintf(nullptr, InsertFormatSpecifier(), );
					CloseHandle(proj);
				}
			}
