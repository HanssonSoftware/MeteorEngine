...
#include <PathCch.h>
#include <ShlObj.h>
#include <Generators/VisualStudio/VisualStudioProject.h>
...
BaseProject* BuildProjectMethod::CreateProjectModule(const char* pathToScript)
{
    return nullptr;
}
...
bool BuildProjectMethod::CreateIntermediateFiles(const String* directory, Array<ScriptModule*> modules)
{
    ...
    for (ScriptModule*& module : modules)
    {
        ...
        {
            //VisualStudioProject* newVSProject = intermediateProcess.Allocate()
        }
